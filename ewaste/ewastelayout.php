...
// Fetch notification list & count to mirror stock layout behavior
$notif_res = null;
$pending_count = 0;
...
<head>
    ...
    <style>
        ...
        /* --- GLOBAL UI UTILITIES --- */
        .bg-emerald-soft { background-color: rgba(18, 59, 99, 0.08); color: var(--primary-accent); }
...
<nav id="sidebar">
    <a href="ewaste_dashboard.php" class="sidebar-brand">
        ...
        <div class="d-flex flex-column">
            <span class="lh-1 fw-bold text-dark fs-5" style="letter-spacing: -0.02em;">EWasteFlow</span>
            <span class="extra-small text-muted fw-medium mt-1" style="font-size: 0.7rem; letter-spacing: 0.03em;">Lifecycle Management</span>
        </div>
    </a>
            ...
            <div class="dropdown">
                <div class="user-profile shadow-sm" data-bs-toggle="dropdown">
                    <div class="text-end d-none d-md-block">
                        ...
                        <p class="extra-small fw-bold mb-0 text-dark"><?= htmlspecialchars($username) ?></p>
