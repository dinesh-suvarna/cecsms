...
<style>
    ...
    .dataTables_length label {
        ...
        align-items: center;
        gap: 12px; /* Pushes the dropdown away from the 'Show' text */
        font-weight: 600;
        color: #64748b;
        margin-bottom: 0;
        font-size: 0.85rem;
    ...
    .dataTables_length select {
        ...
        padding: 0.4rem 1.5rem 0.4rem 0.75rem !important; /* Right padding for arrow */
        cursor: pointer;
        min-width: 70px;
        color: #1e293b;
        font-weight: 700;
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" id="registryForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="item_name" id="item_name" class="form-control rounded-3 border-light-subtle" placeholder="e.g. Office Chair" required>
                        </div>
                        <div class="mb-3">
        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-header bg-white border-0 pt-4 px-4">
                    ...
                    <p class="text-muted small mb-0">Manage and verify furniture classifications</p>
                </div>
