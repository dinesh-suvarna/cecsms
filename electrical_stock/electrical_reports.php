...
$page_title = "Electrical Inventory Master Report";
...
// 2. Fetch Data Grouped (Targeting Electrical Tables)
$sql = "SELECT 
...
$sql .= " ORDER BY inst.institution_name, d.division_name, u.unit_name, ei.item_name ASC";
...
<style>
    ...
    /* Nesting Styles - Electrical Blue Theme */
    .inst-header { background: #1e3a8a !important; color: white !important; font-weight: 700; }
    .div-header { background: #eff6ff !important; color: #1e40af !important; font-weight: 700; padding-left: 2.5rem !important; }
    .unit-header { background: #f8fafc !important; color: #2563eb !important; font-weight: 600; padding-left: 4rem !important; }
...
<div class="container-fluid mt-4">
    ...
    <div class="report-card p-4">
        <div class="text-center mb-4">
            ...
            <h4 class="fw-bold text-uppercase mb-1">Electrical Inventory Master Report</h4>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button inst-header collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#inst-<?= $i_idx ?>">
                            <i class="bi bi-lightning-charge me-2"></i> <?= htmlspecialchars($inst_name) ?>
                        </button>
                    </h2>
                                                                            ...
                                                                            <div class="accordion-item">
                                                                                <h2 class="accordion-header">
                                                                                    <button class="accordion-button type-header collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#type-<?= $i_idx ?>-<?= $d_idx ?>-<?= $u_idx ?>-<?= $t_idx ?>">
                                                                                        <i class="bi bi-cpu me-2"></i> <?= htmlspecialchars($type_name) ?> (<?= count($items) ?>)
                                                                                    </button>
                                                                                </h2>
