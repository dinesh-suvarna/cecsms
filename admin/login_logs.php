...
function getDeviceIcon($name)
{
    ...
    if (
        strpos($name, 'ios') !== false ||
        strpos($name, 'macos') !== false
    ) {
        return 'bi-apple';
    }
...
/* =========================================================
   ...
   They are already considered offline after 5 minutes.
========================================================= */
...
/* =========================================================
   ...
   ---------------------------------------------------------
   No heartbeat is used.

   Active = activity within 2 minutes
   Idle   = activity between 2 and 5 minutes

   Sessions older than 5 minutes are not displayed.
========================================================= */
...
foreach ($active_sessions as $session) {
    ...
    $last_activity_timestamp = strtotime(
        $session['last_activity']
    );

    $seconds_ago = max(
        0,
        time() - $last_activity_timestamp
    );
                            ...
                            <tr>
                                ...
                                <td class="pe-4 text-end">
                                    ...
                                    <span
                                        class="
                                            badge
                                            bg-<?= $status_color ?>-subtle
                                            text-<?= $status_color ?>
                                            border
                                            border-<?= $status_color ?>-subtle
                                            rounded-pill
                                            px-3
                                            py-2
                                        "
            ...
            <?php else: ?>
                ...
                <div class="text-center py-5">
                    ...
                    <small class="text-muted">
                        ...
                        No ERP activity has been detected
        ...
        >
            ...
            <div>
                ...
                <p class="text-muted small mb-0">
                    ...
                    Permanent record of user login activity,
                    geographic footprints, and access environments.
                                ...
                                <td>
                                    ...
                                    >
                                        ...
                                        <?php if (
                                            ...
                                            <img
                                                src="https://flagcdn.com/16x12/<?= strtolower(
                                                    htmlspecialchars(
                                                        $row['country_code']
                                                    )
                                                ) ?>.png"
