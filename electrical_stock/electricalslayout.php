...
<title><?= htmlspecialchars($page_title) ?> | StockFlow Electronics</title>
...
<!-- SIDEBAR -->
<nav id="sidebar">
<a href="electronics_dashboard.php" class="sidebar-brand">
    <div class="bg-primary text-white rounded-3 px-2 py-1 shadow-sm">
        <i class="bi bi-cpu-fill"></i>
    </div>
    <span>Stock<span class="text-dark">Electronics</span></span>
</a>
...
<a href="/cecsms/index.php" class="nav-home-icon">
    <i class="bi bi-house-door"></i>
</a>

<div>
<h5 class="mb-0 fw-bold"><?= htmlspecialchars($page_title) ?></h5>
<p class="text-muted mb-0 d-none d-md-block" style="font-size:11px;">
Managing electronic assets & lifecycle tracking.
</p>
</div>
...
<span class="badge bg-light text-primary" style="font-size:9px;">
