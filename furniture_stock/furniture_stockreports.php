...
// --- UPDATED: LOGIC FOR DYNAMIC FILTER HEADER WITH UNIT CODE ---
$filter_parts = [];
...
$sql = "SELECT 
        ...
        JOIN furniture_items fi ON s.furniture_item_id = fi.id
...
$sql .= " GROUP BY fi.item_name ORDER BY fi.item_name ASC";
...
<style>
    ...
    .table thead { background-color: #f8f9fa; color: #333; text-transform: uppercase; font-size: 0.8rem; }
...
<div class="container-fluid mt-4">
    ...
    <div class="report-card p-4">
        <div class="text-center mb-4">
            ...
            <h4 class="fw-bold text-uppercase mb-1">Consolidated Furniture Stock Report</h4>
