...
// 1. Set the category to Electrical
    ...
    <div class="row align-items-center mb-4">
        <div class="col-md-6">
            <h4 class="fw-bold text-dark mb-1">
                <i class="bi bi-lightning-charge-fill text-warning me-2"></i>Electrical Registry
            </h4>
            <p class="text-muted small">Vendor-wise summary of electrical components and tax breakdowns.</p>
        </div>
                                            ...
                                            <tr class="master-row border-bottom purchase-row">
                                                ...
                                                <td class="text-end pe-4">
                                                    <div class="d-flex justify-content-end gap-2">
                                                        <a href="edit_electrical_ledger.php?id=<?= $l_id ?>" class="btn btn-sm btn-outline-primary">
                                                            ...
                                                            <table class="table table-sm table-bordered bg-white shadow-sm">
                                                                <thead class="table-dark small">
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-end pe-3">Total (Inc. Tax)</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                ...
                                                                <tfoot class="table-light fw-bold small">
                                                                    <tr>
                                                                        <td colspan="4" class="text-end">Bill Subtotal:</td>
                                                                        <td class="text-end pe-3">₹<?= number_format($sum_total, 2) ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="4" class="text-end text-danger">Discount:</td>
                                                                        <td class="text-end pe-3 text-danger">-₹<?= number_format($row['discount_amount'], 2) ?></td>
                                                                    </tr>
                                                                    <tr class="fs-6">
                                                                        <td colspan="4" class="text-end text-primary">Final Net Amount:</td>
...
<style>
    ...
    .vendor-card.highlight { border: 1px solid #ffc107 !important; }
</style>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (urlParams.get('msg') === 'updated') {
        ...
        Toast.fire({
            icon: 'success',
            title: 'Electrical record updated!'
        });
...
function deletePurchase(id, billNo) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch('delete_electrical_purchase.php', {
                method: 'POST',
